...
# ---------------------------------------------------------------------------
# Colour palette — inherited from the DeathRoll design system (Luck §6.3)
# ---------------------------------------------------------------------------
...
def _format_g(amount: int) -> str:
    ...
    The trailing ``g`` is the DeathRoll in-game currency unit (see
...
def online_cashiers_live_embed(
    *,
    ...
    ``snapshot`` is a :class:`deathroll_core.balance.cashier_roster.RosterSnapshot`.
