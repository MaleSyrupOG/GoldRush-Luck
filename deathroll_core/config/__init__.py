"""Settings classes for the DeathRoll bots.
...
- ``CoreSettings`` — fields shared by every DeathRoll bot (DSN, log
...
class CoreSettings(BaseSettings):
    ...
    Production loads them from ``/opt/deathroll/secrets/.env.shared``
