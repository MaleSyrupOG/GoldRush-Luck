"""Entry point for the DeathRoll Deposit/Withdraw bot.

Run with: ``python -m deathroll_deposit_withdraw``
...
from deathroll_deposit_withdraw.client import DwBot, build_bot
