...
from deathroll_core.balance.account_stats import fetch_account_stats
...
class AccountCog(commands.Cog):
    ...
    @app_commands.command(name="balance", description="Show your DeathRoll balance and lifetime totals.")
