...
from deathroll_core.embeds.dw_tickets import withdraw_ticket_open_embed
from deathroll_core.models.dw_pydantic import WithdrawModalInput
...
from deathroll_deposit_withdraw.views.modals import WithdrawModal
...
class WithdrawCog(commands.Cog):
    ...
    async def _on_modal_validated(
        ...
        thread = await create_ticket_thread(
            ...
            reason="DeathRoll withdraw ticket — pre-DB",
        )
